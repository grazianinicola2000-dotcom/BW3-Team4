      ...
      <div className="card shadow-none border-1 mb-2" style={{ borderRadius: '10px' }}>
        <div className="card-body p-3">
          ...
          {profiliConsultati.map((profilo) => (
            <div key={profilo.id} className="d-flex align-items-start mb-3 border-bottom pb-3 last-child-no-border">
              <img 
                src={profilo.img} 
                alt={profilo.nome} 
              ...
              />
              <div className="w-100">
                <div className="fw-bold text-dark" style={{ fontSize: '14px' }}>{profilo.nome}</div>
                <div className="text-secondary mb-2" style={{ fontSize: '12px', lineHeight: '1.2' }}>{profilo.ruolo}</div>
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-3 fw-bold d-flex align-items-center gap-1 border-1" style={{ fontSize: '13px' }}>
