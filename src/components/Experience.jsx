...
const Experience = () => {
  ...
  const experiences = useSelector((currentState) => currentState.experiences.experiences);
  ...
  return (
    <section className="experience-section mt-3">
      <div className="card shadow-none border-1" style={{ borderRadius: "10px" }}>
        <div className="card-body p-2">
          ...
          <div className="dashed-container p-3 position-relative">
            ...
            <h5 className="fw-bold text-secondary mb-1" style={{ fontSize: "18px" }}>
              Experience
            </h5>
            ...
            {experiences?.length === 0 && (
              <div className="d-flex align-items-center mb-3">
                <div className="job-placeholder me-3 d-flex align-items-center justify-content-center">
                  <VscBriefcase className="text-secondary fs-4" style={{ color: "#B2B2B2" }} />
                </div>
                <div>
                  <div className="fw-bold" style={{ fontSize: "16px", color: "#B2B2B2" }}>
                    Job Title
                  </div>
                  <div style={{ fontSize: "14px", color: "#B2B2B2" }}>Organization</div>
                  <div className="text-muted opacity-50" style={{ fontSize: "13px", color: "#B2B2B2" }}>
                    2023 - present
                  </div>
                </div>
              </div>
            )}
            {experiences?.length > 0 && experiences.map((exp) => <ExperienceItem key={exp._id} data={exp} />)}
