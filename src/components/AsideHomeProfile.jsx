  ...
  return (
    <aside className="aside-shared-profile custom-w-rem d-none d-md-block">
      ...
      <div className="card shadow-none border mb-2 rounded-3 bg-white p-3 hover-bg-light cursor-pointer">
        <p className="text-secondary mb-0 x-small-text">Raggiungi i tuoi obiettivi con Premium</p>
        <div className="d-flex align-items-center gap-1">
          <div className="premium-square"></div>
          <span className="fw-bold text-dark x-small-text">Prova Premium per 0 EUR</span>
        </div>
      </div>
      ...
      <div className="card shadow-none border mb-2 rounded-3 bg-white p-3 hover-bg-light cursor-pointer">
        <div className="d-flex justify-content-between align-items-center">
          <div>
            ...
            <p className="text-secondary mb-0 x-small-text">Amplia la tua rete</p>
          </div>
      ...
      <div className="card shadow-none border mb-2 rounded-3 bg-white py-2">
        <div className="d-flex align-items-center gap-3 px-3 py-2 cursor-pointer text-start">
          ...
          <span className="fw-bold text-dark x-small-text">Elementi salvati</span>
        </div>
        <div className="d-flex align-items-center gap-3 px-3 py-2 cursor-pointer text-start">
